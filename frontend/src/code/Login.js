      ...
      <div className="bg-white px-10 py-7 shadow-md rounded-xl border-2 border-gray-200 w-full max-w-md">
        <h1 className="text-3xl font-medium text-center text-blue-950 font-serif">
          ...
          <div className="mt-8 flex flex-col gap-y-4">
            <button onClick={signIn} className="active:scale-[.98] active:duration-75 hover:scale-[1.01] ease-in-out transition-all py-2 rounded-md bg-blue-950 text-white bg-green-500 text-base font-bold">
              LOGIN
            </button>
          </div>
        <div className="mt-8 flex flex-col gap-y-4">
          <div className="flex justify-center items-center">
            <p className="font-medium text-base text-gray-900">Don't have an account?</p>
            
            
            <Link to="/signup">
              <button className="text-blue-500 font-medium ml-2">Sign In</button>
            </Link>
